...
**
###### Introduction
What does it tak universal language? That is the main question which is explored here. A language which can span graphs, programming languages, ..., sciences. A language which you never have to leave.
