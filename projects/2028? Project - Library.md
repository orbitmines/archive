...
Is there a hashing algorithm given a fixed number of possible operations which can recover which was the previous hash & operation, based on the current hash & operation.
