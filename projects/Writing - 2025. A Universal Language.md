...
- Though I'd like to step away from the limitations of a text file, all programming infrastructure relies on it. So ideally we'd like a way to translate the language into a text-based format. Which is where `.ray.txt` comes in.
