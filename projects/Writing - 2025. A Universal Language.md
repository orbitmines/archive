...
###### Examples
- 2d finite vs infinite grid, x-y axis, equal in length, every next value is not in all the other axis (stable 2d growth at each step) .dimensionality() == 2. 2d grid of overlapping graphs for X/Y vs a normal single graph 
