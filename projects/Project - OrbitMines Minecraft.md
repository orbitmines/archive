...
RunSelectionGUI shouldnt be a GUI, but rather a selector like the choice, with holograms. And for the hol9ograms in choice as for this one, we already have an abstraction for holograms/FloatingItems refactor to use that.
