...
### 2
I see description in Choice.java is in english only, like I said every message should use the translation files, and then the dutch translations should be added as well. So revert to using that. where else was this placed improperly? Only make use of the resources for 
