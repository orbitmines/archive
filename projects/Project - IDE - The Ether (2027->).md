...
You also need some reference frame in order to make these judgements. Essentially to comparing two different languages, you are required to have some other language in which to phrase and compare the two. Any judgement you'll make will be relative to this language: if one were to pick a different language as its basis, you might come to different conclusions. One of the things you can also do, is once you have picked your universal language as your reference frame, is to lift it to another reference frame and ignore anything caused by that change of frame. Essentially: once we can translate into our universal language, we can ignore 
