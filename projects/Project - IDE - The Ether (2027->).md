...
User-controlled ownership of data: By creating a new VCS in which the central platform (i.e. the GitHub) is only an index akin to DNS. What I'd need from et al is a way to (1) create accounts for those users
