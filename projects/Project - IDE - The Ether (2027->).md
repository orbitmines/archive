...
That way we can say the top-level `.ether/external/@/@clang` is the currently checked out version, with all the versions in the `nested @`. After a change is made, it's put on 
