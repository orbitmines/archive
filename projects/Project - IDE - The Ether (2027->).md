...
Effectively what we need is a way to render audio/light etc.. to go in all directions. Without having to render all perspectives. But then in a more intelligent way somehow: Interference of abstract structures. ; Construct waves in the world graph. How is that done efficiently?
