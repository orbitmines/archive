...
COmponents which shouldn't override top-level property, but only contents of those properties, and overlay those. (But at what level?) How would you configure this? Set property => {property.* to property.components.last) - Want to say property = property.map dynamically how?
