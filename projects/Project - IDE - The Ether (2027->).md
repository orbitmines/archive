...
- How do you say: Can not send data over the network, only receive? Pretty impossible, get maybe fix the addresses and then no body. But timings can still be used to communicate.
