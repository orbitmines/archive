...
- lowering density of information at each successive step X m away. You need 2x the number of pixels needed to render it provide good quality? (Can we lower density of information of shapes/shaders etc.. to approximations from some distance away?)
