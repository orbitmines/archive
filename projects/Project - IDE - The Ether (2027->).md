...
- World State, Player/Inventory State - both reflect something to about the system controls.
	...
	- Enforcing certain toplogies in certain places; how to get the hint that certain toplogies might be useful there. What is lost? (predictive power?) What is gained? (speed to learn this shape?)?
