...
- So items with insides for the objects, so that would be some frontend backend. The real question is how to construct something similar to functions?
	...
	- 
- Something like if this screensize, is if the ray from certain square size is activiated; part of the chain. Take a ref to that item, and say This: then apply this transformation change. 
