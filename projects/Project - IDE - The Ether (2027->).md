...
- lowering density of information at each successive step X m away. You need 2x the number of pixels needed to render it provide good quality?
	- So what is the screen resolution used at certain perspectives? ; larger screen more pixels of information needed. Use that information to calculate how much to transfer over boundaries
