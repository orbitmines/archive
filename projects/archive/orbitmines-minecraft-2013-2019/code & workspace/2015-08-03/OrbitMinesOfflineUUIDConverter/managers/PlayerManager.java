	...
	public void loadPlayer(final Player p){
		...
		try{	
			...
			*/
			...
			if(DatabaseManager.containsPath("name", "Hub-Players", p.getName())){
				String sBoolean = DatabaseManager.getString(p, "Hub-Players", "players");
				if(sBoolean.equals("false")){
			...
			if(DatabaseManager.containsPath("name", "Hub-Stacker", p.getName())){
				String sBoolean = DatabaseManager.getString(p, "Hub-Stacker", "stacker");
				if(sBoolean.equals("false")){
			...
			if(DatabaseManager.containsPath("name", "Hub-Scoreboard", p.getName())){
				String sBoolean = DatabaseManager.getString(p, "Hub-Scoreboard", "scoreboard");
				if(sBoolean.equals("false")){
			...
			*/
			...
			new BukkitRunnable(){
				public void run(){
					if(ConfigManager.playerdata.contains("players." + p.getName() + ".SendMessages")){
						for(String s : ConfigManager.playerdata.getStringList("players." + p.getName() + ".SendMessages")){
							p.sendMessage(s);
						}
						ConfigManager.playerdata.set("players." + p.getName() + ".SendMessages", null);
						ConfigManager.savePlayerData();
					}
				}
