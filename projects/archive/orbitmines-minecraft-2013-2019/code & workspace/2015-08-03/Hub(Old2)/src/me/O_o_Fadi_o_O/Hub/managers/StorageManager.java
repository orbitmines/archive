...
public class StorageManager {
	...
	public static HashMap<String, Integer> ServerOnlinePlayers = new HashMap<String, Integer>();
	
	public static World HubWorld = Bukkit.getWorld("Hub");
	
	public static Entity alphaEntity = null;
	...
	public static List<String> votesPlayers = new ArrayList<String>();
	
	public static List<String> VoteRewardsNotGiven = new ArrayList<String>();
	
	public static HashMap<String, Boolean> EnablePlayers = new HashMap<String, Boolean>();
	public static HashMap<String, Boolean> EnableStacker = new HashMap<String, Boolean>();
	public static HashMap<String, Boolean> EnableScoreboard = new HashMap<String, Boolean>();
	
	public static HashMap<Player, Pet> PlayerPet = new HashMap<Player, Pet>();
	
	public static HashMap<Player, Boolean> PlayerInOPMode = new HashMap<Player, Boolean>();
	public static HashMap<Player, Boolean> IsLoaded = new HashMap<Player, Boolean>();
	public static HashMap<Player, Boolean> hasClaimedMonthlyVIPPoints = new HashMap<Player, Boolean>();
	
	public static List<Chunk> Chunks = new ArrayList<Chunk>();
	
	public static List<Entity> serverSelectorOcelots = new ArrayList<Entity>();
	public static HashMap<Entity, Entity> serverSelectorOcelotItem = new HashMap<Entity, Entity>();
	public static HashMap<Entity, Location> serverSelectorOcelotLocation = new HashMap<Entity, Location>();
	...
	public static HashMap<Player, Entity> SoccerPlayerMagmaCubes = new HashMap<Player, Entity>();
	...
	public static HashMap<String, Integer> gadgetsMagmaCubeSoccer = new HashMap<String, Integer>();
	...
	public static Entity ParkourNPC = null;
	public static Location ParkourLocation = new Location(HubWorld, -338.5, 12, 1058, -45, 0);
	public static List<Player> PlayersInParkour = new ArrayList<Player>();
	public static HashMap<Player, Boolean> PlayerCompletedParkour = new HashMap<Player, Boolean>();
	
	public static Entity MasterMindNPC = null;
	public static Location MasterMindLocation = new Location(HubWorld, -445.5, 44, 978.5, 0, 0);
	public static List<Player> PlayersInMasterMind = new ArrayList<Player>();
	public static HashMap<Player, Boolean> MasterMindAnimation = new HashMap<Player, Boolean>();
	public static HashMap<Player, Integer> MasterMindAnimationSeconds = new HashMap<Player, Integer>();
	public static HashMap<Player, Integer> MasterMindCurrentTurn = new HashMap<Player, Integer>();
	public static HashMap<Player, List<String>> MasterMindBlocksFromTurns = new HashMap<Player, List<String>>();
	public static HashMap<Player, List<String>> MasterMindStatusFromTurns = new HashMap<Player, List<String>>();
	public static HashMap<Player, String> MasterMindCorrectTurn = new HashMap<Player, String>();
	
	public static HashMap<Integer, List<Block>> MasterMindBlocksForTurn = new HashMap<Integer, List<Block>>();
	public static HashMap<Integer, List<Block>> MasterMindBlocksForTurnStatus = new HashMap<Integer, List<Block>>();
	
	public static Block MasterMindWinsSign = HubWorld.getBlockAt(new Location(HubWorld, -444, 46, 979));
	public static Block MasterMindBestGameSign = HubWorld.getBlockAt(new Location(HubWorld, -448, 46, 979));
	public static HashMap<Player, Integer> PlayerMasterMindWins = new HashMap<Player, Integer>();
	public static HashMap<Player, Integer> PlayerMasterMindBestGame = new HashMap<Player, Integer>();
	
	/*TODO
	 * Achievements:
	 */
	
	public static int KitPvPAchievementsAmount = 8;
	public static HashMap<Player, Integer> KitPvPAchievementsCompleted = new HashMap<Player, Integer>();
	public static HashMap<Player, List<Boolean>> KitPvPAchievements = new HashMap<Player, List<Boolean>>();
	
	public static int HubAchievementsAmount = 5;
	public static HashMap<Player, Integer> HubAchievementsCompleted = new HashMap<Player, Integer>();
	public static HashMap<Player, List<Boolean>> HubAchievements = new HashMap<Player, List<Boolean>>();
	
	public static int SkyBlockAchievementsAmount = 2;
	public static HashMap<Player, Integer> SkyBlockAchievementsCompleted = new HashMap<Player, Integer>();
	public static HashMap<Player, List<Boolean>> SkyBlockAchievements = new HashMap<Player, List<Boolean>>();
	
	public static int MiniGamesAchievementsAmount = 8;
	public static HashMap<Player, Integer> MiniGamesAchievementsCompleted = new HashMap<Player, Integer>();
	public static HashMap<Player, List<Boolean>> MiniGamesAchievements = new HashMap<Player, List<Boolean>>();
	
	/*
	 * NEW:
	*/
	
	public static List<Egg> EggBombs = new ArrayList<Egg>();
	
	public static List<Fireball> Fireballs = new ArrayList<Fireball>();
	...
	public static HashMap<Player, Boolean> ShroomTrail = new HashMap<Player, Boolean>();
	
	public static HashMap<Player, Boolean> BabyPigs = new HashMap<Player, Boolean>();
	public static HashMap<Player, List<Entity>> BabyPigsEntity = new HashMap<Player, List<Entity>>();
	
	public static List<Entity> SilverfishBombs = new ArrayList<Entity>();
	public static HashMap<Player, Boolean> SheepDisco = new HashMap<Player, Boolean>();
	
	public static HashMap<String, String> squid = new HashMap<String, String>();
	public static HashMap<String, String> creeper = new HashMap<String, String>();
	public static HashMap<String, String> spider = new HashMap<String, String>();
	public static HashMap<String, String> chicken = new HashMap<String, String>();
	...
	public static HashMap<String, Integer> disEnderman = new HashMap<String, Integer>();
	public static HashMap<String, Integer> disHorse = new HashMap<String, Integer>();
	public static HashMap<String, Integer> disIronGolem = new HashMap<String, Integer>();
	public static HashMap<String, Integer> disGhast = new HashMap<String, Integer>();
	public static HashMap<String, Integer> disSnowman = new HashMap<String, Integer>();
	public static HashMap<String, Integer> disSkeletonHorse = new HashMap<String, Integer>();
	
	public static HashMap<String, Boolean> wardrobeDisco = new HashMap<String, Boolean>();
	public static HashMap<String, List<Color>> wardrobeUnlockedColors = new HashMap<String, List<Color>>();
	
	public static HashMap<String, Boolean> hatsBlockTrail = new HashMap<String, Boolean>();
	public static HashMap<String, Boolean> hatsHasAHat = new HashMap<String, Boolean>();
	...
	public static HashMap<Player, Entity> ownerpets = new HashMap<Player, Entity>();
}
