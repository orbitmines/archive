...
import me.O_o_Fadi_o_O.OrbitMinesBungeeCord.utils.ServerData;
...
public class DefaultPingManager implements StatusListener {
	...
	public ServerData update() {
		...
		return new ServerData(getRandomStringMessage(), img, 20, "", list);
	}
	
	public static String getNormalMessage(){
        return "                §6§lOrbitMines§4§lNetwork §3§l1.8                      §4§l§k!§c§l§k!§6§l§k! §eName Changing is now Supported! §6§l§k!§c§l§k!§4§l§k!";
	}
	
	public static String getRandomStringMessage(){
		String s = " ";
		if(Start.maintenancemode == false){
			s = "                " + om + " §3§l1.8                      §4§l§k!§c§l§k!§6§l§k! §eName Changing is now Supported! §6§l§k!§c§l§k!§4§l§k!";
			return s;
		}
		else{
