							...
							if(!StorageManager.DeadPlayersInChickenFight.contains(p)){
								if(StorageManager.ChickenFightState.get(StorageManager.PlayersArena.get(p)) == ChickenFightState.INGAME){
									...
									if(StorageManager.ChickenFightKit.get(p).equals("Chicken Mama")){
										long lastUsed = 0;
										if(InteractEvent.lastUsage.containsKey(p.getName())){
											lastUsed = InteractEvent.lastUsage.get(p.getName());
										}
										
										if(currentexp <= 1){
											int timeLeft = (int) (InteractEvent.cdtime-((System.currentTimeMillis()-lastUsed)/1000));
									...
									if(StorageManager.ChickenFightKit.get(p).equals("Baby Chicken")){
										long lastUsed2 = 0;
										if(InteractEvent.lastUsage2.containsKey(p.getName())){
											lastUsed2 = InteractEvent.lastUsage2.get(p.getName());
										}
										
										if(currentexp <= 1){
											int timeLeft = (int) (InteractEvent.cdtime2-((System.currentTimeMillis()-lastUsed2)/1000));
									...
									if(StorageManager.ChickenFightKit.get(p).equals("Hot Wing")){
										long lastUsed3 = 0;
										if(InteractEvent.lastUsage3.containsKey(p.getName())){
											lastUsed3 = InteractEvent.lastUsage3.get(p.getName());
										}
										
										if(currentexp <= 1){
											int timeLeft = (int) (InteractEvent.cdtime3-((System.currentTimeMillis()-lastUsed3)/1000));
									...
									if(StorageManager.ChickenFightKit.get(p).equals("Chicken Warrior")){
										long lastUsed4 = 0;
										if(InteractEvent.lastUsage4.containsKey(p.getName())){
											lastUsed4 = InteractEvent.lastUsage4.get(p.getName());
										}
										
										if(currentexp <= 1){
											int timeLeft = (int) (InteractEvent.cdtime4-((System.currentTimeMillis()-lastUsed4)/1000));
