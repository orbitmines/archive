...
public class StorageManager {
	...
	public static World builderworld = Bukkit.getWorld("BuilderWorld");
	 ...
	 * Player Data
	 */
	public static HashMap<Player, Boolean> silent = new HashMap<Player, Boolean>();
	public static List<Player> canchat = new ArrayList<Player>();
	...
	public static HashMap<Player, Integer> blockdisguise = new HashMap<Player, Integer>();
	...
	public static List<UUID> allvoters = new ArrayList<UUID>();
