...
public class StorageManager {
	...
	public static String boosterplayer = "";
	public static double boosteramount = 1.0;
	public static int boosterminutes = 30;
	public static int boosterseconds = 0;
	
	public static World arenaworld = Bukkit.getWorld("KitPvPArenas");
	public static World lobbyworld = Bukkit.getWorld("KitPvPLobby");
	public static Location spawn;
	public static Location snowtownspectatorspawn;
	public static Location mountainvillagespectatorspawn;
	public static Location desertspectatorspawn;
	
	public static KitPvPMap currentmap = KitPvPMap.Desert;
	
	public static List<Location> mountainvillagespawns = new ArrayList<Location>();
	public static List<Location> snowtownspawns = new ArrayList<Location>();
	public static List<Location> desertspawns = new ArrayList<Location>();
	...
	public static HashMap<Player, Integer> knight = new HashMap<Player, Integer>();
	public static HashMap<Player, Integer> archer = new HashMap<Player, Integer>();
	public static HashMap<Player, Integer> soldier = new HashMap<Player, Integer>();
	public static HashMap<Player, Integer> wizard = new HashMap<Player, Integer>();
	public static HashMap<Player, Integer> tank = new HashMap<Player, Integer>();
	public static HashMap<Player, Integer> drunk = new HashMap<Player, Integer>();
	public static HashMap<Player, Integer> pyro = new HashMap<Player, Integer>();
	public static HashMap<Player, Integer> bunny = new HashMap<Player, Integer>();
	public static HashMap<Player, Integer> necromancer = new HashMap<Player, Integer>();
	public static HashMap<Player, Integer> king = new HashMap<Player, Integer>();
	public static HashMap<Player, Integer> tree = new HashMap<Player, Integer>();
	public static HashMap<Player, Integer> blaze = new HashMap<Player, Integer>();
	public static HashMap<Player, Integer> tnt = new HashMap<Player, Integer>();
	public static HashMap<Player, Integer> fisherman = new HashMap<Player, Integer>();
	public static HashMap<Player, Integer> snowgolem = new HashMap<Player, Integer>();
	public static HashMap<Player, Integer> librarian = new HashMap<Player, Integer>();
	public static HashMap<Player, Integer> spider = new HashMap<Player, Integer>();
	public static HashMap<Player, Integer> villager = new HashMap<Player, Integer>();
	public static HashMap<Player, Integer> assassin = new HashMap<Player, Integer>();
	public static HashMap<Player, Integer> lord = new HashMap<Player, Integer>();
	public static HashMap<Player, Integer> vampire = new HashMap<Player, Integer>();
	public static HashMap<Player, Integer> darkmage = new HashMap<Player, Integer>();
	public static HashMap<Player, Integer> beast = new HashMap<Player, Integer>();
	public static HashMap<Player, Integer> fish = new HashMap<Player, Integer>();
	public static HashMap<Player, Integer> heavy = new HashMap<Player, Integer>();
	public static HashMap<Player, Integer> grimreaper = new HashMap<Player, Integer>();
	public static HashMap<Player, Integer> miner = new HashMap<Player, Integer>();
	...
	public static HashMap<Player, Integer> beststreak = new HashMap<Player, Integer>();
	public static HashMap<Player, Integer> currentstreak = new HashMap<Player, Integer>();
	...
	public static HashMap<Integer, Location> regionlocation = new HashMap<Integer, Location>(); 
	public static HashMap<Integer, Biome> regionbiome = new HashMap<Integer, Biome>();
	public static HashMap<Integer, List<Block>> regionblocks = new HashMap<Integer, List<Block>>();
	...
	public static Entity kitselectornpc;
	public static Entity spectatenpc;
	...
	public static HashMap<Player, KitPlaying> kitselected = new HashMap<Player, KitPlaying>();
