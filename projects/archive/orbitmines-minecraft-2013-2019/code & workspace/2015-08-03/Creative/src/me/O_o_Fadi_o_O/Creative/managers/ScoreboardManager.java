...
public class ScoreboardManager {
	...
	public static void setScoreboard(Player p){
		...
		Team omt = b.registerNewTeam("OMTCrea");
		...
		if(PlayerManager.hasPlot(p)){
			Score score9 = o.getScore(" " + StorageManager.playersplotnumber.get(p) + "  ");
			score9.setScore(1);
		}
		else{
		...
		Team IronVIP = b.registerNewTeam("IronVIPCrea");
		IronVIP.setPrefix("§7§lIron §f");
		Team GoldVIP = b.registerNewTeam("GoldVIPCrea");
		GoldVIP.setPrefix("§6§lGold §f");
		Team DiamondVIP = b.registerNewTeam("DiamondVIPCrea");
		DiamondVIP.setPrefix("§9§lDiamond §f");
		Team EmeraldVIP = b.registerNewTeam("EmeraldVIPCrea");
		EmeraldVIP.setPrefix("§a§lEmerald §f");
		Team Builder = b.registerNewTeam("BuilderCrea");
		Builder.setPrefix("§d§lBuilder §f");
		Team Moderator = b.registerNewTeam("ModeratorCrea");
		Moderator.setPrefix("§b§lMod §f");
		Team Owner = b.registerNewTeam("OwnerCrea");
