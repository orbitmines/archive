...
public class StorageManager {
	...
	public static World KitPvPLobby = Bukkit.getWorld("KitPvPLobby");
	public static World KitPvPArenas = Bukkit.getWorld("KitPvPArenas");
	
	public static KitPvPMap currentMap = KitPvPMap.Snow_Town;
	
	public static Location spawnLocation = new Location(KitPvPLobby, -48.5, 9, -1094.5, 180, 0);
	public static Location SnowTownSpectatorSpawn = new Location(KitPvPArenas, -93.5, 22, -1154.5, 145, 0);
	public static Location MountainVillageSpectatorSpawn = new Location(KitPvPArenas, -308.5, 16, -1326.5, 137, 0);
	...
	public static HashMap<Player, KitPlaying> PlayerKitSelected = new HashMap<Player, KitPlaying>();
	
	public static List<Entity> KitSelectorNPCs = new ArrayList<Entity>();
	public static List<Entity> SpectateNPCs = new ArrayList<Entity>();
	...
	public static HashMap<String, Integer> BestStreak = new HashMap<String, Integer>();
	public static HashMap<String, Integer> CurrentStreak = new HashMap<String, Integer>();
