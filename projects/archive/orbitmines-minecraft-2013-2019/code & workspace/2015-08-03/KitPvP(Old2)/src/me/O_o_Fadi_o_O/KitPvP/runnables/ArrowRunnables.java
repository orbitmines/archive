...
public class ArrowRunnables {
	...
	public ArrowRunnables(Start instance) {
		plugin = instance;
	}
	...
	public void startArcherArrowRunnable(){
			...
			public void run() {
				...
				for(Player p : Bukkit.getOnlinePlayers()){
					if(StorageManager.PlayerKitSelected.containsKey(p)){
						if(StorageManager.PlayerKitSelected.get(p) == KitPlaying.Archer_LvL_1){
						...
						if(StorageManager.PlayerKitSelected.get(p) == KitPlaying.Archer_LvL_2){
						...
						if(StorageManager.PlayerKitSelected.get(p) == KitPlaying.Archer_LvL_3){
		...
		}.runTaskTimer(this.plugin, 0, 20 * 10);
	}
	...
	public void startSoldierArrowRunnable(){
		...
		new BukkitRunnable(){
			...
			public void run() {
				...
				for(Player p : Bukkit.getOnlinePlayers()){
					if(StorageManager.PlayerKitSelected.containsKey(p)){
						if(StorageManager.PlayerKitSelected.get(p) == KitPlaying.Soldier_LvL_1){
						...
						if(StorageManager.PlayerKitSelected.get(p) == KitPlaying.Soldier_LvL_2){
						...
						if(StorageManager.PlayerKitSelected.get(p) == KitPlaying.Soldier_LvL_3){
		...
		}.runTaskTimer(this.plugin, 0, 20 * 18);
	}
	...
	public void startPyroArrowRunnable(){
		...
		new BukkitRunnable(){
			...
			public void run() {
				...
				for(Player p : Bukkit.getOnlinePlayers()){
					if(StorageManager.PlayerKitSelected.containsKey(p)){
						if(StorageManager.PlayerKitSelected.get(p) == KitPlaying.Pyro_LvL_3){
		...
		}.runTaskTimer(this.plugin, 0, 20 * 22);
	}
	...
	public void startNecromancerArrowRunnable(){
		...
		new BukkitRunnable(){
			...
			public void run() {
				...
				for(Player p : Bukkit.getOnlinePlayers()){
					if(StorageManager.PlayerKitSelected.containsKey(p)){
						if(StorageManager.PlayerKitSelected.get(p) == KitPlaying.Necromancer_LvL_1){
						...
						if(StorageManager.PlayerKitSelected.get(p) == KitPlaying.Necromancer_LvL_2){
						...
						if(StorageManager.PlayerKitSelected.get(p) == KitPlaying.Necromancer_LvL_3){
		...
		}.runTaskTimer(this.plugin, 0, 20 * 27);
	}
	...
	public void startTNTArrowRunnable(){
		...
		new BukkitRunnable(){
			...
			public void run() {
				...
				for(Player p : Bukkit.getOnlinePlayers()){
					if(StorageManager.PlayerKitSelected.containsKey(p)){
						if(StorageManager.PlayerKitSelected.get(p) == KitPlaying.TNT_LvL_2){
						...
						if(StorageManager.PlayerKitSelected.get(p) == KitPlaying.TNT_LvL_3){
		...
		}.runTaskTimer(this.plugin, 0, 20 * 30);
	}
	...
	public void startHeavyArrowRunnable(){
		...
		new BukkitRunnable(){
			...
			public void run() {
				...
				for(Player p : Bukkit.getOnlinePlayers()){
					if(StorageManager.PlayerKitSelected.containsKey(p)){
						if(StorageManager.PlayerKitSelected.get(p) == KitPlaying.Heavy_LvL_1){
		...
		}.runTaskTimer(this.plugin, 0, 20 * 21);
	}
}
