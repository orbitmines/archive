...
import me.O_o_Fadi_o_O.KitPvP.utils.Gadget;
...
public class PlayerManager {
	...
	public static void setBossBar(Player p){
		...
		BossbarAPI.setMessage(p, "§7Map Switch in §6§l" + MapRunnable.minutes + "m " + MapRunnable.seconds + "s§7...");
	}
	
	public static void sendMapMessage(Player p){
		if(StorageManager.currentmap == KitPvPMap.Mountain_Village){
			p.sendMessage("§7§m----------------------------------------");
			p.sendMessage(" §6§lOrbitMines§4§lNetwork §7- §c§lKitPvP");
			p.sendMessage(" ");
			p.sendMessage(" §7§lMap: §9§l§nMountain Village");
			p.sendMessage(" ");
			ComponentMessageManager.sendComponentMessage(p, " §7§lBuilt By: ", "§e§l[View]", "show_text", "", "§d§lBuilder §drienk222\n§b§lMod §bsharewoods\n§4§lOwner §4O_o_Fadi_o_O", "");
			p.sendMessage("§7§m----------------------------------------");
		}
			...
			p.sendMessage(" §6§lOrbitMines§4§lNetwork §7- §c§lKitPvP");
			p.sendMessage(" ");
			p.sendMessage(" §7§lMap: §9§l§nSnow Town");
			p.sendMessage(" ");
			ComponentMessageManager.sendComponentMessage(p, " §7§lBuilt By: ", "§e§l[View]", "show_text", "", "§4§lOwner §4O_o_Fadi_o_O\n§d§lBuilder §drienk222", "");
			p.sendMessage("§7§m----------------------------------------");
		}
			...
			p.sendMessage(" §6§lOrbitMines§4§lNetwork §7- §c§lKitPvP");
			p.sendMessage(" ");
			p.sendMessage(" §7§lMap: §9§l§nDesert");
			p.sendMessage(" ");
			p.sendMessage(" §7§lBuilt By: §d§lBuilder §drienk222");
			p.sendMessage("§7§m----------------------------------------");
		}
	}
	...
	*/
	...
	public static void warnPlayerNotLoaded(Player p){
		...
		p.sendMessage("§c§lKitPvP §8| §7This Server just §crestarted§7! Wait a few §cseconds§7.");
	}
	...
	*/
	...
	public void loadPlayer(final Player p){
		...
		try{	
			if(!DatabaseManager.containsPath("uuid", "KitPvP-Kills", uuid)){
				DatabaseManager.insertInt(p.getName(), "KitPvP-Kills", "kills", 0);
			}
			if(!DatabaseManager.containsPath("uuid", "KitPvP-Deaths", uuid)){
				DatabaseManager.insertInt(p.getName(), "KitPvP-Deaths", "deaths", 0);
			}
			if(!DatabaseManager.containsPath("uuid", "KitPvP-Levels", uuid)){
				DatabaseManager.insertInt(p.getName(), "KitPvP-Levels", "levels", 0);
			}
			if(!DatabaseManager.containsPath("uuid", "KitPvP-Money", uuid)){
				DatabaseManager.insertInt(p.getName(), "KitPvP-Money", "money", 0);
			}
			if(!DatabaseManager.containsPath("uuid", "KitPvP-BestStreak", uuid)){
				DatabaseManager.insertInt(p.getName(), "KitPvP-BestStreak", "beststreak", 0);
			}
			
			if(!DatabaseManager.containsPath("uuid", "Kits-Knight", uuid)){
				DatabaseManager.insertInt(p.getName(), "Kits-Knight", "knight", 1);
			}
			
			StorageManager.kills.put(p, DatabaseManager.getInt(p.getName(), "KitPvP-Kills", "kills"));
			StorageManager.deaths.put(p, DatabaseManager.getInt(p.getName(), "KitPvP-Deaths", "deaths"));
			StorageManager.money.put(p, DatabaseManager.getInt(p.getName(), "KitPvP-Money", "money"));
			StorageManager.levels.put(p, DatabaseManager.getInt(p.getName(), "KitPvP-Levels", "levels"));
			StorageManager.beststreak.put(p, DatabaseManager.getInt(p.getName(), "KitPvP-BestStreak", "beststreak"));
			StorageManager.currentstreak.put(p, 0);
			
			if(!StorageManager.knight.containsKey(uuid)){
				StorageManager.knight.put(p, DatabaseManager.getInt(p.getName(), "Kits-Knight", "knight"));
			}
			if(!StorageManager.archer.containsKey(uuid)){
				StorageManager.archer.put(p, DatabaseManager.getInt(p.getName(), "Kits-Archer", "archer"));
			}
			if(!StorageManager.soldier.containsKey(uuid)){
				StorageManager.soldier.put(p, DatabaseManager.getInt(p.getName(), "Kits-Soldier", "soldier"));
			}
			if(!StorageManager.wizard.containsKey(uuid)){
				StorageManager.wizard.put(p, DatabaseManager.getInt(p.getName(), "Kits-Wizard", "wizard"));
			}
			if(!StorageManager.tank.containsKey(uuid)){
				StorageManager.tank.put(p, DatabaseManager.getInt(p.getName(), "Kits-Tank", "tank"));
			}
			if(!StorageManager.drunk.containsKey(uuid)){
				StorageManager.drunk.put(p, DatabaseManager.getInt(p.getName(), "Kits-Drunk", "drunk"));
			}
			if(!StorageManager.pyro.containsKey(uuid)){
				StorageManager.pyro.put(p, DatabaseManager.getInt(p.getName(), "Kits-Pyro", "pyro"));
			}
			if(!StorageManager.bunny.containsKey(uuid)){
				StorageManager.bunny.put(p, DatabaseManager.getInt(p.getName(), "Kits-Bunny", "bunny"));
			}
			if(!StorageManager.necromancer.containsKey(uuid)){
				StorageManager.necromancer.put(p, DatabaseManager.getInt(p.getName(), "Kits-Necromancer", "necromancer"));
			}
			if(!StorageManager.king.containsKey(uuid)){
				StorageManager.king.put(p, DatabaseManager.getInt(p.getName(), "Kits-King", "king"));
			}
			if(!StorageManager.tree.containsKey(uuid)){
				StorageManager.tree.put(p, DatabaseManager.getInt(p.getName(), "Kits-Tree", "tree"));
			}
			if(!StorageManager.blaze.containsKey(uuid)){
				StorageManager.blaze.put(p, DatabaseManager.getInt(p.getName(), "Kits-Blaze", "blaze"));
			}
			if(!StorageManager.tnt.containsKey(uuid)){
				StorageManager.tnt.put(p, DatabaseManager.getInt(p.getName(), "Kits-TNT", "tnt"));
			}
			if(!StorageManager.fisherman.containsKey(uuid)){
				StorageManager.fisherman.put(p, DatabaseManager.getInt(p.getName(), "Kits-Fisherman", "fisherman"));
			}
			if(!StorageManager.snowgolem.containsKey(uuid)){
				StorageManager.snowgolem.put(p, DatabaseManager.getInt(p.getName(), "Kits-SnowGolem", "snowgolem"));
			}
			if(!StorageManager.librarian.containsKey(uuid)){
				StorageManager.librarian.put(p, DatabaseManager.getInt(p.getName(), "Kits-Librarian", "librarian"));
			}
			if(!StorageManager.spider.containsKey(uuid)){
				StorageManager.spider.put(p, DatabaseManager.getInt(p.getName(), "Kits-Spider", "spider"));
			}
			if(!StorageManager.villager.containsKey(uuid)){
				StorageManager.villager.put(p, DatabaseManager.getInt(p.getName(), "Kits-Villager", "villager"));
			}
			if(!StorageManager.assassin.containsKey(uuid)){
				StorageManager.assassin.put(p, DatabaseManager.getInt(p.getName(), "Kits-Assassin", "assassin"));
			}
			if(!StorageManager.lord.containsKey(uuid)){
				StorageManager.lord.put(p, DatabaseManager.getInt(p.getName(), "Kits-Lord", "lord"));
			}
			if(!StorageManager.vampire.containsKey(uuid)){
				StorageManager.vampire.put(p, DatabaseManager.getInt(p.getName(), "Kits-Vampire", "vampire"));
			}
			if(!StorageManager.darkmage.containsKey(uuid)){
				StorageManager.darkmage.put(p, DatabaseManager.getInt(p.getName(), "Kits-DarkMage", "darkmage"));
			}
			if(!StorageManager.beast.containsKey(uuid)){
				StorageManager.beast.put(p, DatabaseManager.getInt(p.getName(), "Kits-Beast", "beast"));
			}
			if(!StorageManager.fish.containsKey(uuid)){
				StorageManager.fish.put(p, DatabaseManager.getInt(p.getName(), "Kits-Fish", "fish"));
			}
			if(!StorageManager.heavy.containsKey(uuid)){
				StorageManager.heavy.put(p, DatabaseManager.getInt(p.getName(), "Kits-Heavy", "heavy"));
			}
			if(!StorageManager.grimreaper.containsKey(uuid)){
				StorageManager.grimreaper.put(p, DatabaseManager.getInt(p.getName(), "Kits-GrimReaper", "grimreaper"));
			}
			if(!StorageManager.miner.containsKey(uuid)){
				StorageManager.miner.put(p, DatabaseManager.getInt(p.getName(), "Kits-Miner", "miner"));
			}
			...
			*/
			...
			TitleManager.setTitle(p, "§6§lOrbitMines§c§lKitPvP", "");
			...
			new BukkitRunnable(){
				public void run(){
					...
					p.sendMessage(" ");
					p.sendMessage(" §7§lKitPvP Spawn Built By: §d§lBuilder §drienk222");
