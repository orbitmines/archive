...
public class ChatColors {
	...
	public ChatColors(Hub instance) {
	plugin = instance;
	}
	...
	public static Inventory getChatColors(final Player p){
		...
		{		
			
			{
				...
				itemlore.add("");
				if(!StorageManager.chatcolordarkred.containsKey(p.getName())){
			...
			}
			{
				...
				List<String> itemlore = new ArrayList<String>();
				itemlore.add("");
				if(!StorageManager.chatcolorlightgreen.containsKey(p.getName())){
			...
			}
			{
				...
				List<String> itemlore = new ArrayList<String>();
				itemlore.add("");
				if(!StorageManager.chatcolordarkgray.containsKey(p.getName())){
			...
			}
			{
				...
				List<String> itemlore = new ArrayList<String>();
				itemlore.add("");
				if(!StorageManager.chatcolorred.containsKey(p.getName())){
			...
			}
			{
				...
				List<String> itemlore = new ArrayList<String>();
				itemlore.add("");
				if(!StorageManager.chatcolorwhite.containsKey(p.getName())){
			...
			}
			{
				...
				List<String> itemlore = new ArrayList<String>();
				itemlore.add("");
				if(!StorageManager.chatcolorlightblue.containsKey(p.getName())){
			...
			}
			{
				...
				List<String> itemlore = new ArrayList<String>();
				itemlore.add("");
				if(!StorageManager.chatcolorpink.containsKey(p.getName())){
			...
			}
			{
				...
				List<String> itemlore = new ArrayList<String>();
				itemlore.add("");
				if(!StorageManager.chatcolorblue.containsKey(p.getName())){
					itemlore.add("§c§oPrice: §b475 VIP Points");
					itemlore.add("§7§o§nClick Here to Buy");
				}
				else{
			...
			}
			{
				...
				List<String> itemlore = new ArrayList<String>();
				itemlore.add("");
				if(!StorageManager.chatcolordarkblue.containsKey(p.getName())){
			...
			}
			{
				...
				List<String> itemlore = new ArrayList<String>();
				itemlore.add("");
				if(!StorageManager.chatcolorgreen.containsKey(p.getName())){
					itemlore.add("§c§oPrice: §b475 VIP Points");
					itemlore.add("§7§o§nClick Here to Buy");
				}
				else{
			...
			}
			{
				...
				List<String> itemlore = new ArrayList<String>();
				itemlore.add("");
				if(!StorageManager.chatcolorblack.containsKey(p.getName())){
