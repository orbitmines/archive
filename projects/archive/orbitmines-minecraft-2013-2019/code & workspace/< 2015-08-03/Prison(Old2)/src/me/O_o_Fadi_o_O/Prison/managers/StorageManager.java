...
public class StorageManager {
	...
	public static HashMap<Block, Hologram> rareChestHolograms = new HashMap<Block, Hologram>();
	...
	public static Location PrisonSpawn = new Location(PrisonWorld, -1207.5, 8, -596, 180, 0);
