...
public class Update {
	...
	public static String getLatestVersionBungeeMSG(){
		...
		try{
			...
			Bukkit.getLogger().warning("[SpigotTestServer] Error while checking for an update.");
        	return "";
        }
	}
	
	public static String getLatestVersionSpigotSpleef(){
