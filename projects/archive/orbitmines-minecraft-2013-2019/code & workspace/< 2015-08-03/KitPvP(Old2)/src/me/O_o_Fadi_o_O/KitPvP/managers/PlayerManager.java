...
public class PlayerManager {
	...
	public static void sendMapMessage(Player p){
		if(StorageManager.currentMap == KitPvPMap.Mountain_Village){
			...
			p.sendMessage(" ");
			p.sendMessage(" §7Map: §9§lMountain Village");
			p.sendMessage(" ");
			p.sendMessage(" §7Built By: §drienk222§7, §bsharewoods§7, §4O_o_Fadi_o_O");
			p.sendMessage("§7§m----------------------------------------");
		}
			...
			p.sendMessage(" §6§lOrbitMines§4§lNetwork §7- §c§lKitPvP");
			p.sendMessage(" ");
			p.sendMessage(" §7Map: §9§lSnow Town");
			p.sendMessage(" ");
			p.sendMessage(" §7Built By: §4O_o_Fadi_o_O§7, §drienk222");
			p.sendMessage("§7§m----------------------------------------");
		}
	}
