...
public class Wardrobe {
	...
	public static Inventory getWardrobeInv(Player p){
		...
		final Inventory inv = Bukkit.createInventory(null, 54, "§0§lWardrobe");
		{
			...
			itemlore.add("");
			if(!StorageManager.white.containsKey(p.getName())){
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!StorageManager.blue.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b250 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!StorageManager.green.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b250 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!StorageManager.black.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b250 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!StorageManager.lightblue.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b250 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!StorageManager.pink.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b250 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!StorageManager.lightgreen.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b250 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!StorageManager.darkblue.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b250 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!StorageManager.purple.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b250 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!StorageManager.orange.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b250 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!StorageManager.red.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b250 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!StorageManager.cyan.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b250 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!StorageManager.yellow.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b250 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!StorageManager.gray.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b250 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
	...
	public static void setDiscoItem(Inventory inv, Player p, Color c, String colorDisplay){
		...
		int i = StorageManager.wardrobeUnlockedColors.get(p.getName()).size();
		
		if(i >= 2){
			if(!StorageManager.wardrobeDisco.containsKey(p.getName())){
