...
public class Gadgets {
	...
	public static Inventory getGadgetsInv(Player p){
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!StorageManager.gadgetsSwapTeleporter.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b500 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!StorageManager.gadgetsMagmaCubeSoccer.containsKey(p.getName())){
