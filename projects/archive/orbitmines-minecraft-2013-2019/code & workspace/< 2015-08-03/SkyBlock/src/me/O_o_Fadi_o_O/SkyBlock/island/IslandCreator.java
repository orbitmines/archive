...
public class IslandCreator {
	...
	public void prepareWorld(final Player p, final int IslandNumber){
		new BukkitRunnable(){
			public void run(){
				World w = StorageManager.skyblockworld;
				
				p.sendMessage(Start.TAG + "§dGenerating Island...");
				TitleManager.setTitle(p, "", "§dGenerating Island...", 0, 100, 0);
				p.playSound(p.getLocation(), Sound.CLICK, 5, 1);
	...
	public void savingData(final Player p, final int IslandNumber, final World w, final Location l){
		new BukkitRunnable(){
			public void run(){
				start.setIslandAmount(IslandNumber);
				...
				TitleManager.setTitle(p, "", "§dIsland Ready!", 0, 100, 0);
	...
	public void teleportPlayer(final Player p){
		...
		new BukkitRunnable(){
			public void run(){
				...
				TitleManager.setTitle(p, "", "§7Teleported to your §dIsland§7.", 0, 20, 20);
			}
