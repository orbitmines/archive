...
public class ServerSelector {
	...
	public static void KitPvPServerItem(Inventory inv, int i){
		
		{
			...
			if(i == 1){
				itemmeta.setDisplayName("§c§lKitPvP §8>> §71.7.2 - 1.7.10");
				itemlore.add("");
				itemlore.add("§7§o§nClick Here to Connect");
				itemlore.add("");
			}
			if(i == 2){
				itemmeta.setDisplayName("§7§lKitPvP §8>> §71.7.2 - 1.7.10");
				itemlore.add("");
	...
	public static void PrisonServerItem(Inventory inv, int i){
		
		{
			...
			List<String> itemlore = new ArrayList<String>();
			if(i == 1){
				itemmeta.setDisplayName("§4§lPrison §8>> §71.7.2 - 1.7.10");
				itemlore.add("");
				itemlore.add("§7§o§nClick Here to Connect");
				itemlore.add("");
			}
			if(i == 2){
				itemmeta.setDisplayName("§7§lPrison §8>> §71.7.2 - 1.7.10");
				itemlore.add("");
				itemlore.add("§7§oClick Here to Connect");
				itemlore.add("");
			}
	...
	public static void CreativeServerItem(Inventory inv, int i){
		
		{
			...
			List<String> itemlore = new ArrayList<String>();
			if(i == 1){
				itemmeta.setDisplayName("§d§lCreative §8>> §71.7.2 - 1.7.10");
				itemlore.add("");
				itemlore.add("§7§o§nClick Here to Connect");
				itemlore.add("");
			}
			if(i == 2){
				itemmeta.setDisplayName("§7§lCreative §8>> §71.7.2 - 1.7.10");
				itemlore.add("");
				itemlore.add("§7§oClick Here to Connect");
				itemlore.add("");
			}
	...
	public static void SurvivalServerItem(Inventory inv, int i){
		
		{
			...
			List<String> itemlore = new ArrayList<String>();
			if(i == 1){
				itemmeta.setDisplayName("§a§lSurvival §8>> §71.7.2 - 1.7.10");
				itemlore.add("");
				itemlore.add("§7§o§nClick Here to Connect");
				itemlore.add("");
			}
			if(i == 2){
				itemmeta.setDisplayName("§7§lSurvival §8>> §71.7.2 - 1.7.10");
				itemlore.add("");
				itemlore.add("§7§oClick Here to Connect");
				itemlore.add("");
			}
	...
	public static void SkyBlockServerItem(Inventory inv, int i){
		
		{
			...
			List<String> itemlore = new ArrayList<String>();
			if(i == 1){
				itemmeta.setDisplayName("§5§lSkyBlock §8>> §71.7.2 - 1.7.10");
				itemlore.add("");
				itemlore.add("§7§o§nClick Here to Connect");
				itemlore.add("");
			}
			if(i == 2){
				itemmeta.setDisplayName("§7§lSkyBlock §8>> §71.7.2 - 1.7.10");
				itemlore.add("");
				itemlore.add("§7§oClick Here to Connect");
				itemlore.add("");
			}
	...
	public static void MiniGamesServerItem(Inventory inv, int i){
		
		{
			...
			List<String> itemlore = new ArrayList<String>();
			if(i == 1){
				itemmeta.setDisplayName("§f§lMiniGames §8>> §71.7.2 - 1.7.10");
				itemlore.add("");
				itemlore.add("§7§o§nClick Here to Connect");
				itemlore.add("");
			}
			if(i == 2){
				itemmeta.setDisplayName("§7§lMiniGames §8>> §71.7.2 - 1.7.10");
				itemlore.add("");
				itemlore.add("§7§oClick Here to Connect");
				itemlore.add("");
			}
