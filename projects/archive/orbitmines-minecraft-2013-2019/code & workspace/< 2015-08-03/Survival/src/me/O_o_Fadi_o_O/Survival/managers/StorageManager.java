...
public class StorageManager {
	...
	public static World survivalworld1 = Bukkit.getWorld("SurvivalWorld");
	public static World lobbyworld = Bukkit.getWorld("SurvivalLobby");
	...
	public static Entity merchantnpc;
	public static Entity jobmanagernpc;
	public static Entity pvpnpc;
	public static Entity omtnpc;
	
	public static HashMap<Entity, Entity> npcItem = new HashMap<Entity, Entity>(); 
	public static Entity regiontpworld1;
	 ...
	 * Player Data
	 */
	public static List<Player> playersinpvp = new ArrayList<Player>();
	public static HashMap<Player, Integer> pvpcountdown = new HashMap<Player, Integer>();
	public static HashMap<Player, Integer> pvpteleporting = new HashMap<Player, Integer>();
	public static HashMap<Player, Integer> spawnteleporting = new HashMap<Player, Integer>();
	
	public static HashMap<Player, Integer> hometeleporting = new HashMap<Player, Integer>();
	public static HashMap<Player, String> hometeleportingto = new HashMap<Player, String>();
	public static HashMap<Player, Location> hometeleportinglocation = new HashMap<Player, Location>();
	
	public static HashMap<Player, Integer> homesallowed = new HashMap<Player, Integer>();
	public static HashMap<Player, List<String>> homes = new HashMap<Player, List<String>>();
	public static HashMap<Player, List<Location>> homelocations = new HashMap<Player, List<Location>>();
