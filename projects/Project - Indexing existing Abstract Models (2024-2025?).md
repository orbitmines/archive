...
- [Infrageometry](https://github.com/WolframInstitute/Infrageometry) (& basically translate to usual hypergraphs), Polycomputation ([[Michael Levin]]), Covariant computation ([[Jonathan Gorard]] doesn't like the name)
