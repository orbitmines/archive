...
- [Transcendental syntax](https://ncatlab.org/nlab/show/transcendental+syntax) ; reminds me of the need to include everything of [[nLab]] needs to be compiled to this list too, so much stuff th
